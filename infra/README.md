...
- **Azure OpenAI (Microsoft Foundry)**: For GPT-4 and GPT-3.5 Turbo models
...
- **AI Capabilities**: Azure OpenAI with GPT-4 and GPT-3.5 Turbo deployments
...
3. **Azure Subscription** with appropriate permissions:
   ...
   - Quota for Azure OpenAI in westus3 region
...
└── modules/
    ...
    ├── openai.bicep                # Azure OpenAI (Microsoft Foundry)
...
The infrastructure provisions Azure OpenAI with the following deployments:

- **GPT-4** (model: gpt-4, version: 0613, capacity: 10)
- **GPT-3.5 Turbo** (model: gpt-35-turbo, version: 0613, capacity: 10)
...
- **Azure OpenAI**: S0 tier (pay-per-token)
...
If Azure OpenAI deployment fails due to quota:
