...
- **Azure OpenAI**: Microsoft Foundry with latest models
  - GPT-4 (version 1106-Preview)
  - GPT-3.5 Turbo (version 0125)
...
- **Modular Bicep Templates**: 6 reusable modules + main orchestrator
  ...
  - `openai.bicep`: Azure OpenAI with model deployments
...
oai-zavastore-dev-westus3             # Azure OpenAI
```
...
6. **AI-Ready**: Azure OpenAI provisioned and configured
